    ...
    >
      <div className="relative w-full h-full">
        ...
        >
          ...
          {/* Glowing Eyes Effect */}
          <div className="absolute top-[30%] left-1/2 -translate-x-1/2 w-32 h-8">
            <div className="absolute top-0 left-1/4 w-4 h-4 bg-quantum-glow rounded-full filter blur-sm animate-glow"></div>
            <div className="absolute top-0 right-1/4 w-4 h-4 bg-quantum-glow rounded-full filter blur-sm animate-glow"></div>
          </div>
        </motion.div>
